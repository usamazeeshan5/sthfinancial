...
// Brand glyphs (white, sized to the button). Simple recognizable marks.
function SocialIcon({ platform }: { platform: string }) {
  ...
  // OnlyFans — the ring "o" mark.
  return (
    <svg viewBox="0 0 24 24" fill="none" className={c}>
      <circle cx="8" cy="12" r="5.5" stroke="currentColor" strokeWidth="3" />
      <circle cx="17.5" cy="8" r="2.2" fill="currentColor" />
    </svg>
  );
}
      ...
      <div className="mt-2.5 grid grid-cols-2 gap-2">
        {links.map((l) => (
          <a
            ...
            className="h-[44px] rounded-xl flex items-center justify-center gap-2 text-white text-[13px] font-semibold active:scale-[0.98] transition-transform"
